...
\end{itemize}
\begin{itemize}
  \item \yes{Il doit être possible de parcourir les dossiers et les
    sous-dossiers}
  ...
  \item \yes{La récupération de la liste des fichiers des sous-dossiers
    ...
    l'icône du dossier)}
  \item \yes{Il devra être possible de revenir au dossier parent (sauf à la racine)}
\end{itemize}
\begin{itemize}
...
\end{itemize}
\begin{itemize}
  \item \yes{Il pourra être possible de générer automatiquement les miniatures}
\end{itemize}
\begin{itemize}
